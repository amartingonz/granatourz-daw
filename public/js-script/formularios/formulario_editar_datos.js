function validarFormulario_editar_datos() {
    ...
    // Validar el campo apellidos (solo letras)
    var apellidosRegex = /^[a-zA-Z\s]+$/;
    if (!apellidosRegex.test(apellidos)) {
      formulario.elements['data[apellidos]'].nextElementSibling.textContent = "El campo de apellidos solo puede contener letras.";
      return false;
    } else {
